 ...
 */
const output = "result1.mp4";
const input = 'portrait.mp4'
let started = Date.now()
const path = "C:/Users/abasi/OneDrive/Desktop"
mergeThumbnail(
  { output: path, workpath: path },
  { logger: { log: console.log }, workpath: path }, {
  input, output,
